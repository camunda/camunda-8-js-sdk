...
const getPath = (filename: string) =>
	path.join(process.cwd(), 'src', '__tests__', 'testdata', filename)
const testBpmnFile = getPath('BpmnParser2.bpmn')
const simpleTestBpmnFile = getPath('BpmnParser.bpmn')
const modeller7File = getPath('modeller7File.bpmn')
