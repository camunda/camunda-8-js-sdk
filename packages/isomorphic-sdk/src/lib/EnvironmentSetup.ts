import { IsoSdkEnvironmentVariableDictionary } from '.'
...
function wipeEnv() {
	...
	IsoSdkEnvironmentVariableDictionary.forEach((key) => delete process.env[key])
}
...
function storeEnv() {
	...
	IsoSdkEnvironmentVariableDictionary.forEach(
